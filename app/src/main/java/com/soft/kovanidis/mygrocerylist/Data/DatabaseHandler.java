package com.soft.kovanidis.mygrocerylist.Data;
...
import com.soft.kovanidis.mygrocerylist.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public DatabaseHandler(@Nullable Context context) {
        super(context, Constants.DB_NAME, null, Constants.BB_VERSION);
        this.ctx =context;
    }

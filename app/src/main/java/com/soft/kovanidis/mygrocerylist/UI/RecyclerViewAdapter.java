package com.soft.kovanidis.mygrocerylist.UI;
...
import com.soft.kovanidis.mygrocerylist.Activities.DetailsActivity;
            ...
            saveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    && !quantity.getText().toString().isEmpty()){
                        ...
                        Snackbar.make(view, "Add Grocery nad Quantity", Snackbar.LENGTH_LONG).show();
                    }
                    dialog.dismiss();
                }
            });
